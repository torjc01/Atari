...
;------------------------------------------------------------------------------
                ...
                include "../include/vcs.h"         ; include the "symbol table" vcs.h, which basically stores constants we can use to represent common values, such as system memory locations  
                ;include "macro.h"      ; include the "symbol table" macro.h, which contains some helper functions 
                include "../include/clr_ntsc.h"    ; include NTSC palette color constants
